function chooseCharater(e) {
    ...
    $(`#animation_charater`).attr('animation', `characterAni 2.5s linear infinite`)
}
...
function scene() {
    const centerRockLeft = document.querySelector('.background-column-left-section2')
    const centerRockRight = document.querySelector('.background-column-right-section2')
    const bottomrightRocks = document.querySelector('.background-rock-right-section2')
    const bottomleftRocks = document.querySelector('.background-rock-left-section2')
    if (
        bottomrightRocks &&
        bottomleftRocks &&
        centerRockLeft &&
